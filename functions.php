...
add_action('init', function () {
	...
	pll_register_string('polylang', 'Поле обязательно.');
	...
	pll_register_string('polylang', 'breadcrumbs-news');
	pll_register_string('polylang', 'breadcrumbs-home');
    ...
    pll_register_string('polylang', 'Скачать');
