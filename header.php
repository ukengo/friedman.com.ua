    ...
    <header class="header">
      ...
      <div class="contacts">
        ...
        <div class="socials socials_header">
          ...
          <a href="//t.me/vit_melnik" class="socials__link socials__link_tg" target="_blank">
          </a>
          <a href="//www.instagram.com/friedmanukraine/?igshid=agxwczlsw46" class="socials__link socials__link_ins"
            target="_blank">
          </a>
        </div>
        <b>
          &nbsp;&nbsp;
          <a style="text-decoration: none;" href="tel:<?php echo $arr_1[0]; ?>">
            <?php echo $arr_1[0]; ?>
          </a> &nbsp;&nbsp;
          <a style="text-decoration: none;" href="tel:<?php echo $arr_2[0]; ?>">
            <?php echo $arr_1[0]; ?>
          </a>
        </b>
      ...
      <a class="btn-order" href="<?php pll_e('link_form'); ?>"><span class="decor">
          <?php pll_e('<strong>Получить</strong> консультацию'); ?></a>


      <div class="lang-search-flex">
