<?
/*
Template Name: Домашняя страница 1й візит
*/
get_header();
...
<style>    /* The Modal (background) */
    ...
    <div id="myModal" class="modal">
      ...
      <div class="modal-content">
        <div class="title-text" style="width: 100%;min-width: 100%;flex-basis: 100%; margin-bottom: 80px; margin-top: 30px; text-align: center; color: #000; font-size: 24px">Ви читаєте новини мовою окупанта</div>
        <div style="width: 50%;flex-basis: 50%; text-align: center; margin-bottom: 30px;">
           <a class="btn-text" style="text-decoration: none; color: #9e0e30; background-color: #fdfeff; padding: 10px 15px; border: 1px solid #9e0e30; border-radius: 5px;" href='https://friedman.com.ua/ru/glavnaya/'>Продовжити</a>
        </div>
        <div style="width: 50%;flex-basis: 50%; text-align: center; margin-bottom: 30px;">
            <a class="btn-text" style="text-decoration: none; color: #9e0e30; background-color: #fdfeff; padding: 10px 15px; border: 1px solid #9e0e30; border-radius: 5px;" href='https://friedman.com.ua/ua/golovna/'>Читати українською</a>
        </div>
      </div>
...
jQuery(document).ready(function($) {
  let lang = document.documentElement.lang;
    if  (lang == 'uk-UA') {
   jQuery('.header .logo').attr('href', '//friedman.com.ua/ua/golovna/');}
});
</script>
    <div class="index-top-sidebar">
        ...
        <div class="right-column">
            <div class="news-sidebar">
               ...
               <?php pll_e('social2'); ?>
                    <a style="position: absolute;top: 9px;right: -2px;color: #959595;font: 12px 'arial';" href="/news/"><?php pll_e('read_all'); ?></a>
                </div>
                <ul>
